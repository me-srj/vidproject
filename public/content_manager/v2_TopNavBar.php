                ...
                <div class="collapse navbar-collapse show" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item">
                          <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="avatar avatar-online"><img src="<?= $call_config->base_url() ?>app-assets/c_manager/<?= $cmg_sess_data['sess_cmg_img'] ?>" alt="avatar"></span></a>
                            <div class="dropdown-menu dropdown-menu-right">
                                 <div class="arrow_box_right"><a class="dropdown-item" href="#"><span class="avatar avatar-online"><img src="<?= $call_config->base_url() ?>app-assets/c_manager/<?= $cmg_sess_data['sess_cmg_img'] ?>" alt="avatar"><span class="user-name text-bold-700 ml-1"></span><?= $cmg_sess_data['sess_cmg_name'] ?></span></a>
<div class="dropdown-divider"></div>

<a class="dropdown-item" href="<?php echo $call_config->base_url() ?>application\view\content_manager\profile/"><i class="ft-user"></i> Edit Profile</a>
<a class="dropdown-item" href="<?php echo $call_config->base_url() ?>application\view\content_manager\change_password/"><i class="ft-lock"></i>Change Password</a>
                                    <div class="dropdown-divider"></div><a class="dropdown-item" href="<?= $call_config->base_url() ?>session_flush.php"><i class="ft-power"></i> Logout</a>
                                </div>
                            </div>
                        </li>
                    </ul>
