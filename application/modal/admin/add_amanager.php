...
// send password in the mail to the account manager
 ...
 $sql="INSERT INTO `tbl_account_manager_master`(`name`, `password`, `mobile`, `email`, `address`, `image`) VALUES ('".$name."','".$password."','".$Phone."','".$email."','".$address."','".$image."')";
if ($call_config->IDU($sql)) {
$call_config->msg('Saved!!',"Account Manager Added successfully!!",'success','admin/a_manager/','');
	}
	else
	{
