...
$sql="UPDATE `tbl_content_manager_master` SET `name`='".$name."',`mobile`='".$mobile."',`email`='".$email."',`address`='".$address."',`uby`='".$sess_adm_data["sess_adm_id"]."' WHERE `id`='".$id."'";
//echo $res;
if ($call_config->IDU($sql)) {
$call_config->msg('Success!!',"Details update successfully!!",'success','admin/c_manager/','');
	}
	else
	{
