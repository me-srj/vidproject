...
<section id="multi-column">
 ...
 <table class="table table-striped table-bordered file-export">
                                <thead>
                                    ...
                                    <?php
                                    $i=0;
$sql="SELECT *  FROM `tbl_video_master` as a  where  publish='verify' and `verification`='0'";
  ...
  <a target="_blank" href="<?= $call_config->base_url() ?>thumbnail/<?= $row['thumbnail'] ?>"><i class="ficon ft-eye"></i></a>
   <?php
    ...
    <td>
     ...
     <td>
       <a href="<?= $call_config->base_url() ?>application/view/content_manager/New_vedios/vedio_details.php?id=<?=$row['id']?>" type="submit" name="submit" class="btn btn-sm round btn-block btn-glow btn-bg-gradient-x-purple-blue">View</a>
     </td>
