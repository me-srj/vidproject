                    		...
                    		<div class="col-md-6">
                    			<div class="form-group">
                    				<div  style="height:200px;width:100%;">
                    					<video class="img-thumbnail" style="width: 100%;height: 100%;"  controls>
                            ...
                            <div class="col-md-6">
                    		 ...
                    		 <div class="form-actions text-right">
                                ...
                                <button type="submit" class="btn btn-danger reject" id="<?php echo $row['id']?>" name="submit">
                                    <i class="la la-trash"></i> Unpublish
                                </button>
...
<script type="text/javascript">
 ...
 $('.reject').on('click',function(){
  ...
  //  alert(data);
    ...
    ths.html('rejected');
     window.location.href="<?php echo $call_config->base_url() ?>application/view/content_manager/All_vedios/";
    $('.publish').hide();
  }
});
     });
