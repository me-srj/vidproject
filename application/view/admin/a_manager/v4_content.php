...
<h4 class="modal-title" id="myModalLabel17">Add Account Manager</h4>
<button type="button" class="close" data-dismiss="modal" aria-label="Close">
<span aria-hidden="true">&times;</span>
</button>
</div>
<form method="POST" action="<?php echo $call_config->base_url() ?>application/modal/admin/add_amanager.php" enctype="multipart/form-data">
...
<button type="submit" class="btn btn-danger" name="submit">Save</button>
 ...
 <table class="table table-striped table-bordered file-export">
                                <thead>
                                    ...
                                    <?php
                                    $i=0;
$sql="SELECT * from tbl_account_manager_master ";
 ...
 ?>
  None
      <?php
            ...
            ?>
  <a target="_blank" href="<?= $call_config->base_url() ?>app-assets\a_manager/<?= $row['image'] ?>"><i class="ficon ft-eye"></i></a>
   <?php
    }
    ?></td>
...
<form method="POST" action="<?php echo $call_config->base_url() ?>application/modal/admin/edit_amanger.php">
<div class="modal-body">
  <div class="form-group">  
...
<form target="_blank" method="POST" action="<?= $call_config->base_url() ?>application/modal/login_page1.php">
  ...
  <input hidden="" type="text" value="2" name="_key">
...
<script type="text/javascript">
 ...
 $(".table").on('click','.Block',function(){
    ...
    $.ajax({
  url:'<?php echo $call_config->base_url().'application/modal/admin/amanager_block.php' ?>',
  type:'POST',
  data:{data:data},
 ...
 $(".table").on('click','.Unblock',function(){
    ...
    var ter = $(this).closest('tr');
       $.ajax({
  url:'<?php echo $call_config->base_url().'application/modal/admin/amanager_unblock.php' ?>',
  type:'POST',
  data:{data:data},
  success:function(data){
