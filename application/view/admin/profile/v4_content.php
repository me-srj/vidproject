<?php 
$session=$sess_adm_data["sess_adm_id"];
$sql="SELECT * FROM `tbl_admin_master` WHERE `id`='$session'";
...
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            ...
                            <div class="form-body">
                                ...
                                <div class="col-md-12">
                                <img src="<?php echo $call_config->base_url().'app-assets\admin\admin_image/'.$result['image']; ?>" id="profile-img-tag" style="width:100px; height:100px" class="img-thumbnail" />
                                <br>
                                <br>
                            </div>
                                <div class="row">
