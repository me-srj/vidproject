...
$sql="SELECT * FROM `tbl_account_manager_master` WHERE `id`='$session'";
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
<form class="form form-horizontal needs-validation" method="POST" enctype="multipart/form-data" action="<?php echo $call_config->base_url()."application/modal/account_manager/update_amg.php"; ?>" novalidate>
...
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            ...
                            <div class="form-body">
                                ...
                                <div class="col-md-12">
                                <img src="<?php echo $call_config->base_url().'app-assets\a_manager/'.$result['image']; ?>" id="profile-img-tag" style="width:100px; height:100px" class="img-thumbnail" />
                                <br>
                                <br>
                            </div>
                                <div class="row">
