...
$query = "SELECT * FROM `tbl_video_master` Where uid='".$id."' AND status='1'";
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                           <div class="video-card-image">
                              <a class="play-icon" href="'.$call_config->base_url().'application/view/user/vedio_page/?id='.base64_encode($row["id"]).'"><i class="fas fa-play-circle"></i></a>
                              <a href="#"><img class="img-fluid" src="'.$call_config->base_url().'/thumbnail/'.$row["thumbnail"].'" alt=""></a>
